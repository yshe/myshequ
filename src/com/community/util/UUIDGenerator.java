...
public class UUIDGenerator { 
    ...
    public static String getUUIDrand(){
    	String s = UUID.randomUUID().toString(); 
    	return s.substring(0,8)+s.substring(28); 
    ...
    * @throws
    ...
    public static String getID(){
    	...
    	buffer.append(RandomUtil.getThreenumRandomCode());
    ...
    public static void main(String[] args){
    	...
    	System.out.println(getUUIDReplaceStr());
    	//System.err.println(getID());
    	/*System.out.println(getUUIDrand());
